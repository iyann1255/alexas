...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AWDfilm")

SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/sepmuksik")
...
GITHUB_REPO = getenv("REPO", "awdfilm.t.me")

SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "fa3b7db7a2ee415685d07f0df979f591")

SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "f6e1d09819624d06922e82a514a86dac")
...
TG_AUDIO_FILESIZE_LIMIT = int(getenv("TG_AUDIO_FILESIZE_LIMIT", "1048574951424"))

TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", "1048574951424"))
# https://www.gbmb.org/mb-to-bytes

COOKIES = getenv("COOKIES", "cookies/cookies.txt" )
# https://batbin.me
